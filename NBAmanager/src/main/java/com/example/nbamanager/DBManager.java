...
public class DBManager {
    ...
    private static final String DB_NOM_E = "Nombre";
    private static final String DB_RES = "Resultado";
    private static final String DB_DIF = "Dificultad";
    ...
    public static ResultSet getTablaJugadores(int typeForwardOnly, int concurUpdatable) {
        try {
            // Ver si la conexión está establecida
            if (conn == null || conn.isClosed()) {
                connect(); // Establecer la conexión si no está establecida
            }
    ...
    public static ResultSet getTablaEstadisticas(int typeForwardOnly, int concurUpdatable) {
        try {
            // Ver si la conexión está establecida
            if (conn == null || conn.isClosed()) {
                connect(); // Establecer la conexión si no está establecida
